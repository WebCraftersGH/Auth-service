...
func (c *DocsHandler) RegisterRoutes(mux *http.ServeMux) {
	mux.HandleFunc("GET /swagger/openapi.json", c.ServeSpec)
	mux.HandleFunc("GET /swagger/", c.ServeUI)
	mux.HandleFunc("GET /swagger", c.RedirectToUI)
}
...
<head>
  ...
  <title>Auth Service Swagger</title>
